import SendEmailWhenProductIsCreatedHandler from "../event/product/handler/send_email_when_product_is_created_handler";
import ProductCreatedEvent from "../event/product/product_created_event";
